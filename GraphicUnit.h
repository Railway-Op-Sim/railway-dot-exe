...
/// Set websafe palette for a specific bitmap
    void SetWebSafePalette(int Caller, Graphics::TBitmap *bmp);  //generated by ChatGPT
/// Uses 'ChangeTransparentColour' method to change each graphic in turn
    void ChangeAllTransparentColours();
...
/// if NewTransparentColour white then change any white pixels in BitmapIn to black in BitmapOut
    void ChangeTransparentColour(Graphics::TBitmap *BitmapIn, Graphics::TBitmap *BitmapOut, TColor OldTransparentColour);
...
/// and route graphics for tracks, underbridges, direction markers and all the point fillets.
    void SetUpAllDerivativeGraphics();
