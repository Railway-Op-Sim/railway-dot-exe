...
// These are the new glyphs for v2.3.0 that stay black, they are transparent, using the bottom LH corner pixel as the transparent colour
    ...
    Modifier->attachCallback([this]() {this->loadGraphics();});
...
void TRailGraphics::loadGraphics() {
    ...
    Modifier->loadGraphic(Code_a, "Code_a");
    Code_a->Transparent = false;
    Modifier->loadGraphic(Code_b, "Code_b");
    Code_b->Transparent = false;
    Modifier->loadGraphic(Code_c, "Code_c");
    Code_c->Transparent = false;
    Modifier->loadGraphic(Code_d, "Code_d");
    Code_d->Transparent = false;
    Modifier->loadGraphic(Code_e, "Code_e");
    Code_e->Transparent = false;
    Modifier->loadGraphic(Code_f, "Code_f");
    Code_f->Transparent = false;
    Modifier->loadGraphic(Code_g, "Code_g");
    Code_g->Transparent = false;
    Modifier->loadGraphic(Code_h, "Code_h");
    Code_h->Transparent = false;
    Modifier->loadGraphic(Code_i, "Code_i");
    Code_i->Transparent = false;
    Modifier->loadGraphic(Code_j, "Code_j");
    Code_j->Transparent = false;
    Modifier->loadGraphic(Code_k, "Code_k");
    Code_k->Transparent = false;
    Modifier->loadGraphic(Code_l, "Code_l");
    Code_l->Transparent = false;
    Modifier->loadGraphic(Code_m, "Code_m");
    Code_m->Transparent = false;
    Modifier->loadGraphic(Code_n, "Code_n");
    Code_n->Transparent = false;
    Modifier->loadGraphic(Code_o, "Code_o");
    Code_o->Transparent = false;
    Modifier->loadGraphic(Code_p, "Code_p");
    Code_p->Transparent = false;
    Modifier->loadGraphic(Code_q, "Code_q");
    Code_q->Transparent = false;
    Modifier->loadGraphic(Code_r, "Code_r");
    Code_r->Transparent = false;
    Modifier->loadGraphic(Code_s, "Code_s");
    Code_s->Transparent = false;
    Modifier->loadGraphic(Code_t, "Code_t");
    Code_t->Transparent = false;
    Modifier->loadGraphic(Code_u, "Code_u");
    Code_u->Transparent = false;
    Modifier->loadGraphic(Code_v, "Code_v");
    Code_v->Transparent = false;
    Modifier->loadGraphic(Code_w, "Code_w");
    Code_w->Transparent = false;
    Modifier->loadGraphic(Code_x, "Code_x");
    Code_x->Transparent = false;
    Modifier->loadGraphic(Code_y, "Code_y");
    Code_y->Transparent = false;
    Modifier->loadGraphic(Code_z, "Code_z");
    Code_z->Transparent = false;
    Modifier->loadGraphic(Code0, "Code0");
    Code0->Transparent = false;
    Modifier->loadGraphic(Code1, "Code1");
    Code1->Transparent = false;
    Modifier->loadGraphic(Code2, "Code2");
    Code2->Transparent = false;
    Modifier->loadGraphic(Code3, "Code3");
    Code3->Transparent = false;
    Modifier->loadGraphic(Code4, "Code4");
    Code4->Transparent = false;
    Modifier->loadGraphic(Code5, "Code5");
    Code5->Transparent = false;
    Modifier->loadGraphic(Code6, "Code6");
    Code6->Transparent = false;
    Modifier->loadGraphic(Code7, "Code7");
    Code7->Transparent = false;
    Modifier->loadGraphic(Code8, "Code8");
    Code8->Transparent = false;
    Modifier->loadGraphic(Code9, "Code9");
    Code9->Transparent = false;
    Modifier->loadGraphic(CodeA, "CodeA");
    CodeA->Transparent = false;
    Modifier->loadGraphic(CodeB, "CodeB");
    CodeB->Transparent = false;
    Modifier->loadGraphic(CodeC, "CodeC");
    CodeC->Transparent = false;
    Modifier->loadGraphic(CodeD, "CodeD");
    CodeD->Transparent = false;
    Modifier->loadGraphic(CodeE, "CodeE");
    CodeE->Transparent = false;
    Modifier->loadGraphic(CodeF, "CodeF");
    CodeF->Transparent = false;
    Modifier->loadGraphic(CodeG, "CodeG");
    CodeG->Transparent = false;
    Modifier->loadGraphic(CodeH, "CodeH");
    CodeH->Transparent = false;
    Modifier->loadGraphic(CodeI, "CodeI");
    CodeI->Transparent = false;
    Modifier->loadGraphic(CodeJ, "CodeJ");
    CodeJ->Transparent = false;
    Modifier->loadGraphic(CodeK, "CodeK");
    CodeK->Transparent = false;
    Modifier->loadGraphic(CodeL, "CodeL");
    CodeL->Transparent = false;
    Modifier->loadGraphic(CodeM, "CodeM");
    CodeM->Transparent = false;
    Modifier->loadGraphic(CodeN, "CodeN");
    CodeN->Transparent = false;
    Modifier->loadGraphic(CodeO, "CodeO");
    CodeO->Transparent = false;
    Modifier->loadGraphic(CodeP, "CodeP");
    CodeP->Transparent = false;
    Modifier->loadGraphic(CodeQ, "CodeQ");
    CodeQ->Transparent = false;
    Modifier->loadGraphic(CodeR, "CodeR");
    CodeR->Transparent = false;
    Modifier->loadGraphic(CodeS, "CodeS");
    CodeS->Transparent = false;
    Modifier->loadGraphic(CodeT, "CodeT");
    CodeT->Transparent = false;
    Modifier->loadGraphic(CodeU, "CodeU");
    CodeU->Transparent = false;
    Modifier->loadGraphic(CodeV, "CodeV");
    CodeV->Transparent = false;
    Modifier->loadGraphic(CodeW, "CodeW");
    CodeW->Transparent = false;
    Modifier->loadGraphic(CodeX, "CodeX");
    CodeX->Transparent = false;
    Modifier->loadGraphic(CodeY, "CodeY");
    CodeY->Transparent = false;
    Modifier->loadGraphic(CodeZ, "CodeZ");
    CodeZ->Transparent = false;
    Modifier->loadGraphic(bmSolidBgnd, "bmSolidBgnd");
    bmSolidBgnd->Transparent = false;
    Modifier->loadGraphic(smSolidBgnd, "smSolidBgnd");
    smSolidBgnd->Transparent = false;
    Modifier->loadGraphic(bmDiagonalSignalBlank, "bmDiagonalSignalBlank");
    bmDiagonalSignalBlank->Transparent = false;
    Modifier->loadGraphic(bmPointBlank, "bmPointBlank");
    bmPointBlank->Transparent = false;
    Modifier->loadGraphic(bmStraightEWSignalBlank, "bmStraightEWSignalBlank");
    bmStraightEWSignalBlank->Transparent = false;
    Modifier->loadGraphic(bmStraightNSSignalBlank, "bmStraightNSSignalBlank");
...
// the following are the stay black glyphs for the speedbuttons
    ...
    Modifier->loadGraphic(TmpBM, "bmSolidBgnd");
